...
public class Student_Edit_Sheet extends BottomSheetDialogFragment {
    ...
    public TextView name_student, regNo_student, mobNo_student;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        name_student = v.findViewById(R.id.textView2);
        regNo_student = v.findViewById(R.id.textView4);
        mobNo_student = v.findViewById(R.id.textView3);
